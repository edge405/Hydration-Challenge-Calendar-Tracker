...
const App = () => {
  const defaultDate = new Date(2025, 7, 1); // July 1, 2025
  ...
  const penaltyData = {
    ...
    "week-2025-03-10": {
      ...
      description:
        "Nicole complied with her penalties, but Edjay did not fulfill his",
    },
    "week-2025-03-17": {
      // Mar 17-21
      penalties: {
    ...
    "week-2025-07-14": {
      // Jul 14-18
      penalties: {
        edjay: ["2025-07-14", "2025-07-15", "2025-07-16", "2025-07-18"],
        nicole: [],
      },
      compliance: {
        edjay: false,
    ...
    "week-2025-07-21": {
      ...
      penalties: {
        edjay: [],
        nicole: ["2025-07-21", "2025-07-24", "2025-07-25"],
      },
      compliance: {
        edjay: true,
        nicole: false,
      },
      description: "Nicole did not complete her penalties",
    },
    "week-2025-07-28": {
      // Jul 28 - Aug 1
      penalties: {
        edjay: ["2025-07-29", "2025-07-30", "2025-07-31"],
        nicole: ["2025-07-28", "2025-07-29"],
      },
      compliance: {
        edjay: false,
        nicole: false,
    ...
    "week-2025-08-11": {
      ...
      description: "Nicole completed her penalties",
    },
    "week-2025-08-18": {
      // Aug 18-22
      penalties: {
        edjay: ["2025-08-21", "2025-08-22"],
        nicole: ["2025-08-21"],
      },
      compliance: {
        edjay: false,
        ...
        if (dayNumber > 0 && dayNumber <= daysInMonth) {
          ...
          if (isAfterStartDate && isBeforeEndDate) {
            ...
            if (isWeekendDay) {
              ...
              prevWeek.setDate(
                prevWeek.getDate() -
                  (isWeekendDay ? (currentDate.getDay() === 0 ? 1 : 2) : 0)
              );
              const weekKey = `week-${prevWeek
                .toISOString()
                .split("T")[0]
                .slice(0, 10)}`;
              const weekData = penaltyData[weekKey];
              ...
              if (weekData) {
                week.push(
                  <div key={`day-${dayNumber}`} className="p-1">
                    <div
                      className={`${cardBg} rounded-md p-1 sm:p-2 shadow-sm border-2 border-dashed ${borderColor}`}
                    >
                      <div
                        className={`text-center mb-1 ${textColor} text-xs sm:text-base`}
                      >
                        {dayNumber}
                      </div>
                      <div className="text-xs text-center text-gray-400 mb-1 hidden sm:block">
                        Weekend
                      </div>
                ...
                week.push(
                  <div key={`day-${dayNumber}`} className="p-1">
                    ...
                    >
                      <div
                        className={`text-center mb-1 sm:mb-2 ${textColor} text-xs sm:text-base`}
                      >
                        {dayNumber}
                      </div>
                      <div className="text-xs text-center italic text-gray-500 truncate">
                        Weekend
                      </div>
                    </div>
                  </div>
                ...
                <div key={`day-${dayNumber}`} className="p-1">
                  <div className={`${cardBg} rounded-md p-1 sm:p-2 shadow-sm`}>
                    ...
                    <div className="grid gap-1">
                      <div
                        className={`text-xs text-center rounded py-1 ${
                          edjayMissed ? edjayFailureColor : edjaySuccessColor
                    ...
                    <div className="mt-1 grid gap-1">
                      <div
                        className={`text-xs text-center rounded py-1 ${
                          nicoleMissed ? nicoleFailureColor : nicoleSuccessColor
                        } flex items-center justify-center`}
                      >
                        <span className="hidden sm:inline">
                          {challenge.participants.nicole.name}
            ...
            week.push(
              <div key={`day-${dayNumber}`} className="p-1">
                <div
                  className={`${inactiveBg} rounded-md p-1 sm:p-2 opacity-50`}
                >
                  <div
                    className={`text-center mb-1 sm:mb-2 ${textColor} text-xs sm:text-base`}
                  >
  ...
  return (
    <div
      className={`${bgColor} ${textColor} min-h-screen w-full transition-colors duration-200`}
    >
      <div className="container mx-auto px-2 sm:px-4 py-3 sm:py-6">
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
          <div className="md:col-span-2 order-2 md:order-1">
            ...
            {/* Calendar Grid */}
            <div className="mb-4 sm:mb-6">{renderCalendarDays()}</div>

            {/* Color Legend */}
            <div
              className={`${cardBg} rounded-lg p-3 sm:p-4 shadow-md mb-4 sm:mb-6`}
            >
              ...
              <div className="grid grid-cols-2 gap-y-2 text-xs sm:text-sm">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-3 h-3 sm:w-4 sm:h-4 rounded ${edjaySuccessColor}`}
                  ></div>
                  <span>Target Achieved</span>
                </div>
                <div className="flex items-center gap-2">
                  <div
                    className={`w-3 h-3 sm:w-4 sm:h-4 rounded ${edjayFailureColor}`}
                  ></div>
          ...
          <div className="space-y-4 sm:space-y-6 order-1 md:order-2">
            ...
            <div className={`${cardBg} rounded-lg p-3 sm:p-4 shadow-md`}>
              <h2 className="text-center text-lg sm:text-xl font-bold mb-3 sm:mb-4">
                Monthly Penalty Counter
              </h2>
              <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center mb-3 sm:mb-4">
                ...
                <div>
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-yellow-500">
                    {monthlyPenalties.nicole}
                  </div>
                </div>
                <div>
                  <h3 className="text-sm sm:text-base">Total</h3>
                  <div className="text-xl sm:text-2xl font-bold text-yellow-500">
                    {monthlyPenalties.edjay + monthlyPenalties.nicole}
                  </div>
                </div>
              </div>
              <div className="text-center p-2 sm:p-3 rounded-lg bg-opacity-25 bg-yellow-500 text-sm sm:text-base">
                ...
                <p className="text-xl sm:text-2xl font-bold">
                  {getMonetaryPenalty(currentMonth.getMonth())} Pesos/Missed Day
                </p>
              </div>
                ...
                <div className="space-y-2 sm:space-y-3">
                  {getWeeklySummary().length > 0 ? (
                    getWeeklySummary().map(([weekKey, data]) => {
                      ...
                      const bothCompleted =
                        data.compliance.edjay && data.compliance.nicole;
                      const noneCompleted =
                        !data.compliance.edjay && !data.compliance.nicole;
                      ...
                      return (
                        <div
                          key={weekKey}
                          className={`p-2 sm:p-3 rounded-lg ${bgColor}`}
                        >
                          ...
                          <div className="mt-2 grid grid-cols-2 gap-2">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center">
                                <span className="text-xs mr-1">
                                  {data.penalties.edjay.length} penalties
                                </span>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center">
                                <span className="text-xs mr-1">
                                  {data.penalties.nicole.length} penalties
                                </span>
                    ...
                    <div className="text-center p-4 text-gray-400 text-sm">
                      No penalty data for this month
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="block md:hidden">
                <details>
                  ...
                  <ol className="list-decimal pl-4 space-y-1 text-xs mt-2">
                    ...
                    <li>
                      Participants must report their water intake at the end of
                      each day via video or picture.
                    </li>
                    <li>
                      Penalty for missing water target:{" "}
                      {getPenaltyAmount(currentMonth.getMonth())}km jog/walk on
                      weekend.
                    </li>
                    <li>
                      Failure to complete exercise:{" "}
                      {getMonetaryPenalty(currentMonth.getMonth())} pesos per
                      missed day.
                    </li>
                    <li>
                      Challenge runs from January 20, 2025 to August 31, 2025.
                    </li>
